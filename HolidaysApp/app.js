...
var _user$project$HolidaysApp_App_Model$initialModel = function () {
	var location = {href: 'String', host: 'String', hostname: 'String', protocol: 'String', origin: 'String', port_: 'String', pathname: 'String', search: 'String', hash: 'String', username: 'String', password: 'String'};
	return {
		someString: 'Welcom to Thomas Cook',
		forexAppModel: A2(_user$project$ForexApp_App_Model$initAppModel, location, _user$project$ForexApp_App_Route$Home)
	};
}();
var _user$project$HolidaysApp_App_Model$Model = F2(
	function (a, b) {
		return {someString: a, forexAppModel: b};
	});

var _user$project$HolidaysApp_App_Msg$ForexAppMsg = function (a) {
	return {ctor: 'ForexAppMsg', _0: a};
};
var _user$project$HolidaysApp_App_Msg$AppMessage = {ctor: 'AppMessage'};

var _user$project$HolidaysApp_App_View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('3 Holidays Found'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
							...
							},
							{
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Sandos Papagayo Beach Resort'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Spain, Canary Islands, Lanzarote, Playa Blanca'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('£864 pp'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
								...
								},
								{
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Barcelo Teguise Beach'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Spain, Canary Islands, Lanzarote, Costa Teguise'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('£1,307 pp'),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
									...
									},
									{
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('SENTIDO Aequora Lanzarote'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Spain, Canary Islands, Lanzarote, Los Pocillos'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('£768 pp'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Currency Exchange'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
					...
					_1: {
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									_elm_lang$html$Html$map,
									_user$project$HolidaysApp_App_Msg$ForexAppMsg,
									_user$project$ForexApp_App_View$view(model.forexAppModel)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$HolidaysApp_App_Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'AppMessage') {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		} else {
			var _p1 = A2(_user$project$ForexApp_App_Update$update, _p0._0, model.forexAppModel);
			var forexModel = _p1._0;
			var forexcmd = _p1._1;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{forexAppModel: forexModel}),
				_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$HolidaysApp_App_Msg$ForexAppMsg, forexcmd)
			};
		}
	});

var _user$project$HolidaysApp$init = {ctor: '_Tuple2', _0: _user$project$HolidaysApp_App_Model$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
var _user$project$HolidaysApp$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$HolidaysApp$main = _elm_lang$html$Html$program(
	{init: _user$project$HolidaysApp$init, view: _user$project$HolidaysApp_App_View$view, update: _user$project$HolidaysApp_App_Update$update, subscriptions: _user$project$HolidaysApp$subscriptions})();

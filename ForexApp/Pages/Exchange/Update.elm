...
import StoreLocator.DataModules.StoreList
import Navigation
...
update msg model =
  case msg of
    ...
    Msg.OnDisplaySelectStores isModalVisible ->
      ( { model | storeModalIsVisible = isModalVisible }, Cmd.map Msg.SelectStoreMsg StoreLocator.DataModules.StoreList.loadStores)
